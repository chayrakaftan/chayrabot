  ...
  switch (intent) {
    ...
    case 'info_produit': {
      ...
      if (/(fabri[qc]|origine|maroc|fait.*main|artisan|sfifa|broder|ou sont fait|ou est fait|provenance|savoir-faire|savoir faire)/.test(m)) {
        ...
        return {
          reply: lang === 'en'
            ? 'Our gandouras are made in **Morocco**.\nThe **Sfifa** on our products is entirely handcrafted by Moroccan artisans following traditional techniques passed down through generations.\n\nWhich model would you like to know the fabric of?'
            : 'Nos gandouras sont conçues et fabriquées au **Maroc**.\nLa **Sfifa** de nos produits est entièrement réalisée à la main par des artisans marocains selon un savoir-faire transmis de génération en génération.\n\nDe quel modèle souhaitez-vous connaître la matière ?',
          suggestions: ['Gandoura Abaya', 'Gandoura Papillon', 'Gandoura Mixte', 'Autre question'],
